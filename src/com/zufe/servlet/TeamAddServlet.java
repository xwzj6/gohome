...
public class TeamAddServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		team.setTeamProvince(request.getParameter("teamProvince"));
		team = teamDao.addTeam(team);
		out.println("<script type='text/javascript'>");
		out.println("alert('创建成功！Id编号为"+team.getTeamId() +"');");
		out.println("window.location='manage/team_list.jsp';");
		out.println("</script>");
		out.flush();
		out.close();
	}
