			...
			<ul class="sidebar-menu" id="nav-accordion">
				...
				<li class='sub-menu '><a href="1"
					...
					<ul class='sub'>
						...
						<li><a href='check/admin_distribution.jsp' class="active">任务分配</a>
						</li>
					</ul>
				</li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="c_panel">
                            ...
                            <div class="c_title">
                                ...
                                <!-- 页数信息 -->
                                <div align="center">
							<a href="check/admin_distribution.jsp?pageNo=1"><i  class="glyphicon glyphicon-step-backward" style="font-size: 15px;"></i></a>&nbsp;
							<%
								if (lostPage.isHasPreviousPage()) {
							%>
							<a
								href="check/admin_distribution.jsp?pageNo=<%=lostPage.getPageNo() - 1%>"><i  class="glyphicon glyphicon-chevron-left" style="font-size: 15px;"></i></a>&nbsp;
							<%
								}
							%>
							<%
							...
							%>
							<a
								href="check/admin_distribution.jsp?pageNo=<%=lostPage.getPageNo() + 1%>"><i  class="glyphicon glyphicon-chevron-right" style="font-size: 15px;"></i></a>&nbsp;
							<%
								}
							%>
							<a
							href="check/admin_distribution.jsp?pageNo=<%=lostPage.getTotalPages()%>"><i  class="glyphicon glyphicon-step-forward" style="font-size: 15px;"></i></a>&nbsp;
						...
						<tbody>
							<tr>
								...
								<td><a href="PeopleInfoGetServlet?peopleId=<%=p.getPeopleId()%>"><%=p.getPeopleId() %></a></td>
								...
								<td>
									<form action="LostDistributionServlet?lostId=<%=l.getLostId() %>&type=<%="team" %>" method="post">
									<div class="login_l">
