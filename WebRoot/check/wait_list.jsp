		...
		<div class="leftside-navigation leftside-navigation-scroll">
			<ul class="sidebar-menu" id="nav-accordion">
				...
				<li class='sub-menu '><a href="1"
					...
					<ul class='sub'>
						<li><a href='check/wait_list.jsp' class="active">待审核<span class="badge label-info"></span></a>
						</li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="c_panel">
                            ...
                            <div class="c_title">
                                <!-- 页数信息 -->
                                <div align="center">
							<a href="check/wait_list.jsp?pageNo=1"><i  class="glyphicon glyphicon-step-backward" style="font-size: 15px;"></i></a>&nbsp;
							<%
								if (lostPage.isHasPreviousPage()) {
							%>
							<a
								href="check/wait_list.jsp?pageNo=<%=lostPage.getPageNo() - 1%>"><i  class="glyphicon glyphicon-chevron-left" style="font-size: 15px;"></i></a>&nbsp;
							<%
								}
							%>
							<%
							...
							%>
							<a
								href="check/wait_list.jsp?pageNo=<%=lostPage.getPageNo() + 1%>"><i  class="glyphicon glyphicon-chevron-right" style="font-size: 15px;"></i></a>&nbsp;
							<%
								}
							%>
							<a
							href="check/wait_list.jsp?pageNo=<%=lostPage.getTotalPages()%>"><i  class="glyphicon glyphicon-step-forward" style="font-size: 15px;"></i></a>&nbsp;
						...
						<tbody>
							<tr>
								...
								<td>
									<a href=""><img style="width:25px;height:25px;" src="img/OK.png"></a>
