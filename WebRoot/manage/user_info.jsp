        ...
        <section id="main-content">
            ...
            <section class="wrapper">
				...
				<%
								...
								list = recordPage.getPageData(u.getUserId());
                                ...
                                <div class="col-lg-6 col-xs-6 widget">
                                    <div class="widget-content bg-white">
                                        <div class="row padding-10">
                                            <div class="col-xs-6">
                                                <h3><span class="counter"><%=list.size() %></span></h3>
                                            </div>
                                            <div class="col-xs-6">
                                        ...
                                        <a href="#" class="padding-8 hvr-bounce-to-right bg-sun-flower bg-opacity-8" style="width:100%;">任务详情 <i class="fa fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="widget-content bg-white">
                                        <div class="row padding-10">
                                            <div class="col-xs-6">
												...
												%>
													<h3><span ><%=teamDao.getTeamByTeamId(u.getTeamId())
															.getTeamName()%></span></h3>
												<%
													}
												%>
                                        ...
                                        <a href="#" class="padding-8 hvr-bounce-to-right bg-alizarin bg-opacity-8" style="width:100%;">队伍详情 <i class="fa fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table about-table">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <th>ID号</th>
                                                                        <td><%=u.getUserId()%> <span class="icon-pencil pull-right"></span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>姓名</th>
                                                                        <td><%=u.getUserName() %><span class="icon-pencil pull-right"></span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>职务</th>
                                                                        <td><%=u.getUserState() %> <span class="icon-pencil pull-right"></span></td>
                                                                    </tr>
                                                                    <tr>
                                                                    	<th>队伍</th>
                                                                        <%
																			if (u.getUserState().equals("超级管理员")|| u.getUserState().equals("管理员")) {
																		%>
																		<td>无<span class="icon-pencil pull-right"></span></td>
																		<%
																			} else {
																		%>
																		<td><%=teamDao.getTeamByTeamId(u.getTeamId())
																		.getTeamName()%><span class="icon-pencil pull-right"></span></td>
																		<%
																			}
																		%>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>年龄</th>
                                                                        <td><%=u.getUserAge()%> <span class="icon-pencil pull-right"></span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>性别</th>
                                                                        <td><%=u.getUserSex()%> <span class="icon-pencil pull-right"></span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>电话</th>
                                                                        <td><%=u.getUserPhone()%><span class="icon-pencil pull-right"></span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>微信</th>
                                                                        <td><%=u.getUserWechat() %><span class="icon-pencil pull-right"></span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>地址</th>
                                                                        <td><%=u.getUserAddress() %><span class="icon-pencil pull-right"></span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>注册日期</th>
                                                                        <td><%=u.getUserRegistDate()%> <span class="icon-pencil pull-right"></span></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="panel panel-profile">
                                        <div class="panel-heading overflow-hidden">
                                            <h2 class="panel-title heading-sm pull-left"><i class="fa fa-tasks"></i>任务记录</h2>
                                                    ...
                                                    <div class="list-group contact-group">
                                                    	...
                                                    	if (list != null)
															for (Record r : list) {
																People p = new People();
																p = peopleDao
																		.getPeopleByPeopleId(r.getLost().getPeopleId());
                                                    	 %>
                                                        <a href="#" class="list-group-item">
                                                            <div class="media">
                                                                <div class="pull-left">
                                                                    <img class="img-circle" src="img/oldman.jpg" alt="...">
                                                                </div>
                                                                <div class="media-body">
                                                                    <h4 class="media-heading"><%=p.getPeopleName()%> <small>任务ID:<%=r.getLost().getLostId()%></small></h4>
                                                                    <div class="media-content">
                                                                        	失踪日期 :<%=r.getLost().getLostDate()%>
                                                                        <ul class="list-unstyled">
                                                                            <li>是否找到:<%=(r.getLost().getIsFind() == 1 ? "是" : "否")%></li>
                                                                            <li>任务用时:<%=r.getLost().getFinishHour()%></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div><!-- media -->
