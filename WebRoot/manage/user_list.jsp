			...
			<ul class="sidebar-menu" id="nav-accordion">
				...
				<li class='sub-menu '><a href="1"
					...
					<ul class='sub'>
						...
						<li><a href='manage/user_list.jsp' class="active">成员列表</a>
						</li>
					</ul>
				</li>
				<li class='sub-menu '><a href="1"
        ...
        <section id="main-content">
			...
			<small>五个哈哈团队</small>
                    ...
                    <div class="right-menu pull-right">
                        ...
                        <nav class="c_breadcrumbs">
                            <a href="" class="btn btn-green btn-flat btn-add-new-user" data-toggle="modal" data-target="#modal-pull-right-add"><span class="icon-user-follow"></span> 添加成员</a>
                        </nav>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="c_panel">
                            ...
                            <div class="c_title">
                                ...
                                <!-- 页数信息 -->
                                <div align="center">
							<a href="manage/user_list.jsp?pageNo=1"><i  class="glyphicon glyphicon-step-backward" style="font-size: 15px;"></i></a>&nbsp;
							<%
								if (userPage.isHasPreviousPage()) {
							%>
							<a
								href="manage/user_list.jsp?pageNo=<%=userPage.getPageNo() - 1%>"><i  class="glyphicon glyphicon-chevron-left" style="font-size: 15px;"></i></a>&nbsp;
							<%
								}
							%>
							<%
							...
							%>
							<a
								href="manage/user_list.jsp?pageNo=<%=userPage.getPageNo() + 1%>"><i  class="glyphicon glyphicon-chevron-right" style="font-size: 15px;"></i></a>&nbsp;
							<%
								}
							%>
							<a
							href="manage/user_list.jsp?pageNo=<%=userPage.getTotalPages()%>"><i  class="glyphicon glyphicon-step-forward" style="font-size: 15px;"></i></a>&nbsp;
						当前是第<jsp:getProperty property="pageNo" name="userPage" />页，总共<jsp:getProperty
							property="totalPages" name="userPage" />页
					</div>
                            ...
                            <div class="c_content">
<!--  
                                <p>It is uses RWD Table Patterns for responsive table, you can visit their official website 
                                <a href="http://gergeo.se/RWD-Table-Patterns/">here</a> for more information.</p>
     -->                           
