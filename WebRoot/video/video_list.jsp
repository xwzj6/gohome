...
<html>
  <head>
    ...
    <!--This css plugins uses only this page only-->
    <link href="assets/vendors/dropzone/dropzone.min.css" rel="stylesheet" />
    <link href="assets/vendors/plupload/js/jquery.plupload.queue/css/jquery.plupload.queue.css" rel="stylesheet" type="text/css"/>
                    ...
                    <div class="col-md-12">
                        ...
                        <div id="user-view" class="row list-group">
							<% 
								...
								videoList=videoDao.getAllVideo();
								UserDao userDao=new UserDao();
								for(Video v:videoList){
									User u=new User();
									u=userDao.getUserById(v.getUserId());
							 %>
                            <div class="item col-md-3">
                                <div class="thumbnail">
                                    <a href="video/video_player.jsp?videoId=<%=v.getVideoId() %>">
                                    <img style="height:200px; width:300px;" class="group list-group-image img-responsive " src="videos/pic/<%=v.getVideoPic() %>"  alt="image" />
									
									</a>
                                    <div class="user-info">
                                        <p class="user-name"></p>
                                        <p class="user-type administrator"><span class="badge"></span></p>
                                    </div>
                                    <div class="caption">
                                        ...
                                        <div class="user-other-info">
                                            ...
                                            <li></li>
                                            <li>
                                            	<i class="fa fa-th-large"></i><%=v.getVideoName() %>
                                        	</li>
                                                <li>
                                                    <i class="fa fa-circle-o"></i> 
                                                    <span><a href="#"><%=u.getUserName() %></a></span>
                                                </li>
                                                <li>
                                                <i class="fa fa-circle-o"></i> 
                                                     <span><a href="#"><%=u.getUserState() %></a></span>
                                                </li>
                                            </ul>
                                        </div>
